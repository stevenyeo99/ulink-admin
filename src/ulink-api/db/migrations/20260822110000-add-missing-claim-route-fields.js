...
// Adds fields that exist on the real source documents (both sample PDFs) but were missing
// from the original extraction_schema entirely — not an omitted-value bug like the previous
// migration, these keys never existed in the schema at all.

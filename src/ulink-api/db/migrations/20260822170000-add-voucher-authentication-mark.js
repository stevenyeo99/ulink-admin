...
// Closes a confirmed JD1-scope gap: "Missing/invalid clinic stamp, doctor stamp, or SAMA
// on voucher where required" (docs/samples/20260820/20260821 ULINK STP Confirmed
// Assumptions and Implementation Advice.md, JD1 checklist). Verified against real sample
// data (incomplete/jd1/1, Shin Minn Thi): a handwritten voucher carrying only a generic
// pharmacy dispensing stamp was rejected by the human reviewer for lacking a clinic stamp
// or the doctor's own signature+stamp — a printed institutional receipt (complete/2) or a
// clinic-letterhead voucher bearing the clinic's stamp (complete/1) both passed. LLM-judged
// (not code-derived) because it requires distinguishing an institutional/doctor
// authentication mark from an unrelated stamp (e.g. a pharmacy's own dispensing stamp),
// which is a visual judgment call, same category as identity_consistency.

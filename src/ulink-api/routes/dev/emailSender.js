 ...
 *                 dryRun: { type: boolean }
 *                 taskId: { type: string }
 *                 taskType: { type: string, enum: [MISSING_DOCUMENTS, DOCUMENT_COMPLETE_ACK, MEMBER_VERIFY_ISSUE, CLAIM_SUBMIT_ISSUE, SUBMISSION_NOT_RECOGNIZED, CLAIM_APPROVAL_REVIEW] }
